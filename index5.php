...
<html lang="en">
    ...
    <?php require('header.php'); ?>
        ...
        <main>
            ...
            ?>
            <!-- 投稿の画像を取得する -->
            <?php $postss = $db->query('SELECT m.name, m.picture AS member_picture, p.picture AS post_picture, p.* FROM members m, posts p WHERE m.id=p.member_id ORDER BY p.created DESC');?>
